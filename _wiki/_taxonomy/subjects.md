...
Open-ended list of named-entity Subjects encountered during ingestion. Updated by
`/wiki apply`. Subjects are people, organisations, datasets, methods, models, and
specific named artefacts. Concepts belong in `topics.md`, not here.
...
- subject/daniela-amodei
- subject/dario-amodei
- subject/deep-ganguli
- subject/ethan-perez
...
- subject/lennart-heim
- subject/long-ouyang
- subject/nelson-elhage
